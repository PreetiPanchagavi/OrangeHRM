...
public class WiniumHandler extends ExtentReportListener {
    ...
    public String winiumAILocators(String rowid, String filePath, String sheetName) throws Exception {

        Map<String, String> TestDataInMap = ExcelHandler.getTestDataInMap(filePath, sheetName, rowid);
        String systemDir = System.getProperty("user.dir");
        String imageName = TestDataInMap.get("ElementPath");
        String path = systemDir + "\\Winium-Projects\\OPHELIE_Distrib\\" + imageName;
